  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li class="divider"></li>
        <li class="dropdown-header"><?php echo $text_pending_products; ?></li>
        <li><a href="<?php echo $pending_products; ?>"><span class="label label-warning pull-right"><?php echo $pending_products_total; ?></span><?php echo $text_pending; ?></a></li>
      </ul>
    </li>
