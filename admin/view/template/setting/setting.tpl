          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-customer-group-donor">
                  <?php echo $entry_customer_group_donor; ?>
                  </label>
                  <div class="col-sm-10">
                    <select name="config_customer_group_donor_id" id="input-customer-group-donor" class="form-control">
                      <?php foreach ($customer_groups as $customer_group) { ?>
                      <?php if ($customer_group['customer_group_id'] == $config_customer_group_donor_id) { ?>
                      <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-customer-group-benef">
                  <?php echo $entry_customer_group_benef; ?>
                  </label>
                  <div class="col-sm-10">
                    <select name="config_customer_group_benef_id" id="input-customer-group-benef" class="form-control">
                      <?php foreach ($customer_groups as $customer_group) { ?>
                      <?php if ($customer_group['customer_group_id'] == $config_customer_group_benef_id) { ?>
                      <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  ...
                  <?php echo $entry_organaization_group; ?>
                  </label>
                  <div class="col-sm-10">
                    <select name="config_user_group_id" id="input-user-group" class="form-control">
                      <?php foreach ($user_groups as $user_group) { ?>
                      <?php if ($user_group['user_group_id'] == $config_user_group_id) { ?>
