    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <li>
            <a href="#tab-product-history" data-toggle="tab">
              <?php echo $tab_product_history; ?>
            </a>
          </li>
        ...
        <div class="tab-content">
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <?php # Update Start By: Ismail Ashour ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php # Update Start By: Ismail Ashour ?>
                  <td class="text-left">
                    <a target="_blank" href="<?php echo $product['recipient_href']; ?>">
                    <?php echo $product['recipient']; ?>
                    </a>
                  </td>
                  <?php # Update End ?>
          ...
          <div class="tab-pane" id="tab-product-history">
          <fieldset>
            <legend><?php echo $text_history; ?></legend>
            ...
            <div id="product-history-<?php echo $product['order_product_id']; ?>"></div>
            <br />
              <form class="form-horizontal" id="product-history-form-<?php echo $product['order_product_id']; ?>">
                <!-- Start Update By: Ismail Ashour -->
                <div class="form-group required organaztion_notes">
                  <label class="col-sm-2 control-label">
                    <?php echo $entry_purchase_source; ?>
                  </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="purchase_source" value="" />
                  </div>
                </div>
                <div class="form-group required organaztion_notes">
                  <label class="col-sm-2 control-label">
                    <?php echo $entry_purchase_price; ?>
                  </label>
                  <div class="col-sm-10">
                ...
                <div class="form-group required organaztion_notes">
                  <label class="col-sm-2 control-label">
                    <?php echo $entry_product_details; ?>
                  </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="product_details" value="" />
                  </div>
                </div>
        
                <div class="form-group required organaztion_notes">
                  <label class="col-sm-2 control-label" for="input-date-delivery"><?php echo $entry_delivery_date; ?></label>
                  <div class="col-sm-3">
                    <div class="input-group datetime">
                      <input type="text" name="delivery_date" value="<?php echo date('Y-m-d'); ?>" placeholder="<?php echo $entry_delivery_date; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-date-delivery" class="form-control" />
                ...
                <div class="form-group required organaztion_notes">
                  <label class="col-sm-2 control-label">
                    <?php echo $entry_order_recipient; ?>
                  </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="order_recipient" value="" />
                  </div>
                </div>
                <!-- Ended Update -->
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_product_status; ?></label>
                  <div class="col-sm-10">
                    <select name="order_status_id" id="input-order-status" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $order_status_id) { ?>
                ...
                <input type="hidden" name="recipient_id" value="<?php echo $product['recipient_id']?>" />
              </form>
              <div class="text-right">
                <button id="button-product-history-<?php echo $product["order_product_id"] ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_history_add; ?></button>
              </div>
            <br />
          <?php endforeach; ?>
          </fieldset>
...
$('#product-history-<?php echo $product["order_product_id"] ?>').delegate('.pagination a', 'click', function(e) {

  e.preventDefault();
  
  $('#product-history-<?php echo $product["order_product_id"] ?>').load(this.href);
});

$('#product-history-<?php echo $product["order_product_id"] ?>').load('index.php?route=sale/order/product_history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&order_product_id=<?php echo $product["order_product_id"] ?>');

$('#button-product-history-<?php echo $product["order_product_id"] ?>').on('click', function() {
  ...
  $.ajax({
    url: 'index.php?route=sale/order/api&token=<?php echo $token; ?>&api=api/order/product_history&order_id=<?php echo $order_id; ?>&order_product_id=<?php echo $product["order_product_id"] ?>',
    type: 'post',
    dataType: 'json',
    data: 'order_status_id=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> select[name=\'order_status_id\']').val()) + '&notify=' + ($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + ($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> textarea[name=\'comment\']').val()) + '&purchase_source=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'purchase_source\']').val()) + '&purchase_price=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'purchase_price\']').val()) + '&product_details=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'product_details\']').val())  + '&delivery_date=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'delivery_date\']').val())  + '&order_recipient=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'order_recipient\']').val()) + '&recipient_id=' + encodeURIComponent($('#product-history-form-<?php echo $product["order_product_id"] ?> input[name=\'recipient_id\']').val()) + '&order_product_id=<?php echo $product["order_product_id"] ?>',
    beforeSend: function() {
      $('#button-product-history-<?php echo $product["order_product_id"] ?>').button('loading');      
    },
    complete: function() {
      $('#button-product-history-<?php echo $product["order_product_id"] ?>').button('reset');  
    },
    success: function(json) {
      $('.alert').remove();

      if (json['error']) {
        $('#product-history-<?php echo $product["order_product_id"] ?>').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
      } 
      ...
      if (json['success']) {
        ...
        $('#product-history-<?php echo $product["order_product_id"] ?>').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
...
function changeStatus(){
  var status_id = $('#product-history-<?php echo $product["order_product_id"] ?> select[name="order_status_id"]').val();
  ...
  $.ajax({
    ...
    success: function(html) {
      $('#product-history-<?php echo $product["order_product_id"] ?>').after(html);
    }
  });
}


$('#product-history-form-<?php echo $product["order_product_id"] ?> select[name="order_status_id"]').change(function(){ 
  
  if ($( this ).val() == <?php echo $config_complete_status ?> ){
    $('#product-history-form-<?php echo $product["order_product_id"] ?> .organaztion_notes').css('display', 'block');
  } else {
    $('#product-history-form-<?php echo $product["order_product_id"] ?> .organaztion_notes').css('display', 'none');
  }
...
function changeStatus(){
  var status_id = $('#history select[name="order_status_id"]').val();
...
$(document).ready(function() {
  ...
  $('.organaztion_notes') .css('display', 'none');
