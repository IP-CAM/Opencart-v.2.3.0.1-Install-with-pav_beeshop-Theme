...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['text_pending_products'] = $this->language->get('text_pending_products');
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$pending_product_total         = $this->model_sale_customer->getTotalCustomers(array('filter_product_status' => 'pending'));
			$data['pending_products_total'] = $pending_product_total;
			$data['pending_products']       = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&filter_product_status=pending', 'SSL');
			# Update End
			...
			// Processing Orders
			$data['order_status_total'] = 
$this->model_sale_order->getTotalOrders(array('filter_order_status' => $this->config->get('config_order_status_id')));
			$data['order_status'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&filter_order_status=' . $this->config->get('config_order_status_id'), 'SSL');
			...
			$data['alerts'] = $customer_total + $product_total + $review_total + $return_total + $affiliate_total + $pending_product_total;
