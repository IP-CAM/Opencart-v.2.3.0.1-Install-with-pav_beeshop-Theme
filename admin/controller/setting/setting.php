...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_customer_group_benef'] = $this->language->get('entry_customer_group_benef');
		$data['entry_customer_group_donor'] = $this->language->get('entry_customer_group_donor');
		$data['entry_organaization_group'] = $this->language->get('entry_organaization_group');
		# Update End
		...
		# Update Start By: Ismail Ashour
		if (isset($this->request->post['config_customer_group_donor_id'])) {
			$data['config_customer_group_donor_id'] = $this->request->post['config_customer_group_donor_id'];
		} else {
			$data['config_customer_group_donor_id'] = $this->config->get('config_customer_group_donor_id');
		}

		if (isset($this->request->post['config_customer_group_benef_id'])) {
			$data['config_customer_group_benef_id'] = $this->request->post['config_customer_group_benef_id'];
		} else {
			$data['config_customer_group_benef_id'] = $this->config->get('config_customer_group_benef_id');
		}

		if (isset($this->request->post['config_user_group_id'])) {
			$data['config_user_group_id'] = $this->request->post['config_user_group_id'];
		} else {
