...
<body class="<?php echo $class; ?>">
                ...
                <?php if ($mmos_social_notify_message): ?>
                <div class="container" id="mmos_social_notify_message" style="display: none;">
                    <div class="alert alert-success" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <i class="fa fa-exclamation-circle"></i> <?php echo $mmos_social_notify_message; ?>
                    </div>
                </div>
            <script type="text/javascript">
                $(function(){
                    $('nav#menu').closest('div.container').after($('#mmos_social_notify_message'));
                    $('#mmos_social_notify_message').show();
                });
            </script>
            <?php endif; ?>                              
        ...
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <?php if(isset($social_login_popup)) { ?>        
                <li><a href="#dialog-loginbox" data-toggle="modal"><?php echo $text_login; ?></a></li> 
            <?php } else { ?>  
