<div class="row">
  ...
  <div class="col-sm-6">
    ...
    <input type="button" value="<?php echo $button_login; ?>" id="button-login" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
                ...
                <div style="margin-top: 15px;margin-bottom: 15px; display:none" id="mmosolution_show_social-checkout"></div>
                <script type="text/javascript">
                $(document).ready(function () {
                    if(typeof show_social_custom_page != 'undefined' && show_social_custom_page !==''){

                     $('#mmosolution_show_social-checkout').html($('#mmos-social-login_show').html()).show();
                  }
                });
                </script>  
