...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4d8dbc7f665084e1" async="async"></script>
 
            <?php if(isset($social_login_popup)) { ?>        
              <?php require_once(DIR_APPLICATION.'view/theme/default/template/mmosolution/social_login_popup.tpl'); ?>     
            <?php }  ?>  
            <?php if (isset($social_login_items)) { ?> 
                 <?php require_once(DIR_APPLICATION.'view/theme/default/template/mmosolution/social_login.tpl'); ?>    
             <?php }  ?>  
             <?php if(isset($mmos_social_login_required_fields_form)){ ?>   
                <?php require_once(DIR_APPLICATION.'view/theme/default/template/mmosolution/social_login_required_fields_modal.tpl'); ?>    
             <?php } ?>
