  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content">
    ...
    <?php echo $content_top; ?>
      <h3 class="page-title"><?php echo $heading_title; ?>
        <?php if ($weight) { ?>
        &nbsp;(<?php echo $weight; ?>)
        <?php } ?>
      </h3>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-center"><?php echo $column_customer_name; ?></td>
                <!-- # Update End -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a target="_blank" href="<?php echo $product['customer_href']; ?>">
                ...
                <div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <input type="hidden" name="quantity[<?php echo $product['key']; ?>]" value="1" size="1" class="form-control" />
                </div>
                <!-- # Update End -->
                </td>
              ...
              <tr>
                ...
                <td class="text-center"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <span class="input-group-btn"><button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-primary" onclick="voucher.remove('<?php echo $vouchers['key']; ?>');"><i class="fa fa-times-circle"></i></button></span></div></td>
