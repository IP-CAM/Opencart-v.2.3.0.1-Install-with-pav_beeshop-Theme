...
<div class="widget panel panel-default nopadding">
	<?php if( $show_title ) { ?>
	<div class="widget-heading panel-heading hightlight  space-10"><h3 class="panel-title"><?php echo $heading_title?></h3></div>
	<?php } ?>
