          ...
          <?php foreach($fields as $field){ ?>
            ...
            <?php if($field['type'] == "select"){ ?>
              <select id="<?php echo $field['id']; ?>"  name="<?php echo $field['id']; ?>">
                ...
                <?php if($field['id']=='customer_group_id') { ?>
                  <?php foreach($customer_groups as $customer_group) {?>
                  <option value="<?php echo $customer_group['customer_group_id']; ?>" <?php echo ($customer_group['customer_group_id'] == $profile_value[$field['id']]) ? 'selected="selected"': ''; ?>><?php echo $customer_group['name']; ?></option>
                  <?php } ?>
                <?php } ?>
                <!-- # Update End -->
