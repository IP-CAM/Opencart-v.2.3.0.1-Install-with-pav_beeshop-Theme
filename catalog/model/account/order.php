...
class ModelAccountOrder extends Model {
	...
	public function getOrders($start = 0, $limit = 20) {
		...
		$query = $this->db->query("SELECT o.order_id,
			...
			o.total,
			o.currency_code,
			o.currency_value FROM `" . DB_PREFIX . "order` o
	...
	public function getOrderHistories($order_id, $order_product_id) {
		...
		$query = $this->db->query("SELECT
			...
			os.name AS status,
			oh.comment,
			oh.notify FROM " . DB_PREFIX . "order_history oh 
			LEFT JOIN " . DB_PREFIX . "order_status os ON oh.order_status_id = os.order_status_id
			LEFT JOIN " . DB_PREFIX . "order_product op ON op.order_product_id = oh.order_product_id
