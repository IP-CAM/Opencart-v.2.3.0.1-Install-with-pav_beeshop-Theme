...
class ControllerModuleSocialLoginFree extends Controller {
	...
	public function index($setting) {
		...
		$this->document->addStyle('catalog/view/theme/default/stylesheet/social_login_free/css/socialicious.css');
				...
				if(!$popup){
					...
					if(!$customer){
						...
						foreach ($customer_groups as $customer_group) {
							if ( $customer_group['customer_group_id'] == $this->config->get('config_customer_group_donor_id') 
								|| $customer_group['customer_group_id'] == $this->config->get('config_customer_group_benef_id'))
