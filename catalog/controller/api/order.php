...
class ControllerApiOrder extends Controller {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				...
				$this->model_checkout_order->addOrderHistory(
					...
					$this->request->post['purchase_source'],
					$this->request->post['purchase_price'],
					$this->request->post['product_details'],
					$this->request->post['delivery_date'],
					$this->request->post['order_recipient']);
				# Update End
				$json['success'] = $this->language->get('text_success');
			} else {
				$json['error'] = $this->language->get('error_not_found');
	...
	public function product_history() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				$this->model_checkout_order->addOrderProductHistory(
					$order_id,
					$this->request->post['order_product_id'],
					$this->request->post['order_status_id'],
					$this->request->post['comment'],
					$this->request->post['notify'],
					$this->request->post['purchase_source'],
					...
					$this->request->post['delivery_date'],
					$this->request->post['order_recipient'],
					$this->request->post['recipient_id']
				);
