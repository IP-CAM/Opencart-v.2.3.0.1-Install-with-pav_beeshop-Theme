		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			foreach ($products as $product) {
				...
				$data['products'][] = array(
					...
					'name'          => $product['name'],
					# Update Start By: Ismail Ashour
					'customer_href'   => $this->url->link('account/profile', 'customer_id=' . $product['customer_id']),
	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json && $customer) {
				...
				$this->cart->add($this->request->post['product_id'], $quantity, $option, $recurring_id, $customer_id, $customer_name);
